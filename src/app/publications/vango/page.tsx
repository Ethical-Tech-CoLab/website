...
export const metadata: Metadata = {
  ...
  description:
    "An Ethical Tech CoLab report on a digital souvenir passport in which a visitor scans or types a code beside an artwork and collects a dated stamp, a record of attendance and nothing more.",
};

export default function VangoPage() {
  return (
    <>
      {/* Hero */}
        ...
        <div className="relative mx-auto max-w-4xl px-6 py-20 sm:py-24">
          ...
          <Reveal delay={0.2}>
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              >
                Open the passport <span aria-hidden>↗</span>
              </a>
              <a
                href={vangoReport.repoUrl}
                target="_blank"
                rel="noopener noreferrer"
      ...
      <div className="mx-auto max-w-4xl px-6 py-16 sm:py-20">
        ...
        <Reveal delay={0.05}>
          ...
          >
            ...
            <ol className="mt-4 grid gap-2 sm:grid-cols-2">
              {vangoReport.sections.map((section) => (
                <li key={section.id}>
                  <a
                    href={`#${section.id}`}
        ...
        <section id="references" className="mt-16 scroll-mt-24">
          ...
          <ol className="mt-8 space-y-4 text-sm leading-relaxed text-muted">
            {vangoReport.citations.map((cite, i) => (
        ...
        <section className="mt-16 rounded-2xl border border-border bg-card p-6">
          <p className="text-sm leading-relaxed text-muted">
            ...
            demonstration only. VANGO has not been deployed in a live exhibition
            setting, and nothing it records constitutes evidence of attendance,
            ownership, authenticity, or the lawful origin of any work of art.
          </p>
        </section>
