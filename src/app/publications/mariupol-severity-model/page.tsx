...
export const metadata: Metadata = {
  ...
  description:
    "An Ethical Tech CoLab report on a research prototype that scores a single daily measure of civilian danger for every day of the siege of Mariupol, March to May 2022, and anchors each component to the legal obligation it bears on.",
};

export default function MariupolSeverityModelPage() {
  return (
    <>
      {/* Hero */}
        ...
        <div className="relative mx-auto max-w-4xl px-6 py-20 sm:py-24">
          ...
          <Reveal delay={0.2}>
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              >
                Open the live model <span aria-hidden>↗</span>
              </a>
              <a
                href={mariupolReport.repoUrl}
                target="_blank"
                rel="noopener noreferrer"
              ...
              <ReportPdfLink slug="mariupol-severity-model" />
      ...
      <div className="mx-auto max-w-4xl px-6 py-16 sm:py-20">
        ...
        <Reveal delay={0.05}>
          ...
          >
            ...
            <ol className="mt-4 grid gap-2 sm:grid-cols-2">
              {mariupolReport.sections.map((section) => (
                <li key={section.id}>
                  <a
                    href={`#${section.id}`}
        ...
        <section id="references" className="mt-16 scroll-mt-24">
          ...
          <ol className="mt-8 space-y-4 text-sm leading-relaxed text-muted">
            {mariupolReport.citations.map((cite, i) => (
        ...
        <section className="mt-16 rounded-2xl border border-border bg-card p-6">
          <p className="text-sm leading-relaxed text-muted">
            ...
            prototype is retrospective and is for academic demonstration only.
            Its outputs are indicative and are not a substitute for operational
            decision-making, legal advice, or assessment by qualified
            humanitarian and IHL professionals. Summaries of the parties&apos;
            conduct are descriptive and attributed to the sources named, not
            adjudicative. Nothing here constitutes a factual or legal
            determination about the conduct of any party to the conflict.
          </p>
        </section>
