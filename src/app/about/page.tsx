...
// ─────────────────────────────────────────────────────────────────────────
// About page is TEMPORARILY HIDDEN (2026-07-13, pending a decision on its
// content). Nothing is deleted: the page's data still lives in the `about`
// object in src/content/site.ts, and the full page layout is preserved below
// as comments. To bring it back:
//   1. Delete the `notFound()` stub export below.
//   2. Uncomment the imports, `metadata`, `SectionLabel`, and `AboutPage`.
//   3. Re-add { label: "About", href: "/about" } to `nav` in src/content/site.ts.
// ─────────────────────────────────────────────────────────────────────────

export default function AboutPage() {
  // Route is hidden — serve a 404 rather than an empty shell.
  notFound();
}
